...
@Directive({
  selector: '[mnNg1xlte3Collapse]',
  exportAs: 'mn-ng1xlte3-collapse',
  host: {
    '[class.collapse]': 'true'
  }
})
export class Ng1xLTE3CollapseDirective implements AfterViewChecked, AfterContentInit {
  
  /** This event fires as soon as content collapses */
  @Output() collapsed: EventEmitter<Ng1xLTE3CollapseDirective> = new EventEmitter();
  /** This event fires when collapsing is started */
  @Output() collapses: EventEmitter<Ng1xLTE3CollapseDirective> = new EventEmitter();
  /** This event fires as soon as content becomes visible */
  @Output() expanded: EventEmitter<Ng1xLTE3CollapseDirective> = new EventEmitter();
  /** This event fires when expansion is started */
  @Output() expands: EventEmitter<Ng1xLTE3CollapseDirective> = new EventEmitter();
